...
export class RequestInterceptor implements HttpInterceptor {
  intercept(httpRequest: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    if (httpRequest.url.toString()=="api/receiptauth" || httpRequest.url.toString()=="api/tokenauth" || httpRequest.url.toString()=="api/authentication" || httpRequest.url.toString()=="api/reset/password") {

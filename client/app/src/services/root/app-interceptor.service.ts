...
export class appInterceptor implements HttpInterceptor {
  ...
  intercept(httpRequest: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    if (httpRequest.url.includes("api/signup") || httpRequest.url.includes("api/auth/session") || httpRequest.url.endsWith("api/auth/receiptauth") && !this.authenticationService.session || protectedUrls.includes(httpRequest.url)) {

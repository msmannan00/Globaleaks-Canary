...
export class SubmissionStatusResolver implements Resolve<boolean> {
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> {
    let requestObservable = this.httpService.requestSubmissionStatusResource({"id": this.authentication.session.id})

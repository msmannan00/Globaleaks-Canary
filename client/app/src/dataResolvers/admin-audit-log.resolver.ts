...
export class AdminAuditLOgResolver implements Resolve<boolean> {
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> {
    let requestObservable = this.httpService.requestAdminAuditLogResource({"id": this.authentication.session.id})

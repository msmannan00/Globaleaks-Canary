...
export class AdminTenantResolver implements Resolve<boolean> {
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> {
    let requestObservable = this.httpService.requestAdminTenantResource({"id": this.authentication.session.id})

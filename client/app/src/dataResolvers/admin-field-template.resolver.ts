...
export class AdminFieldTemplateResolver implements Resolve<boolean> {
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> {
    let requestObservable = this.httpService.requestAdminFieldTemplateResource({"id": this.authentication.session.id})

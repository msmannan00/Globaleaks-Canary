...
export class ForcedTwoFactorComponent {
  constructor(public twofactorauthData:TwofactorauthData, public httpService: HttpService, public preferenceResolver:PreferenceResolver, public authenticationService:AuthenticationService, private router:Router) {
  }

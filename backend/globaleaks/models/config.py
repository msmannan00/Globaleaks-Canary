...
default_tenant_keys = ["subdomain", "onionservice", "https_admin", "https_analyst", "https_cert", "wizard_done", "uuid", "mode", "default_language", "name", "disable_submissions", "encryption", "https_whistleblower", "receipt_salt", "counter_submissions", "crypto_escrow_pub_key"]
